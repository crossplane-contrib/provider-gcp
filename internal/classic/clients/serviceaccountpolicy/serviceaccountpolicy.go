...
func GenerateServiceAccountPolicyInstance(in v1alpha12.ServiceAccountPolicyParameters, p *iam.Policy) {
	...
	p.Version = v1alpha12.PolicyVersion
}

// IsUpToDate checks whether current state is up-to-date compared to the given
// set of parameters.
func IsUpToDate(in *v1alpha12.ServiceAccountPolicyParameters, observed *iam.Policy) (bool, error) {
