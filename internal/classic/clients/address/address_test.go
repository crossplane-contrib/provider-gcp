...
func params(m ...func(*v1beta12.AddressParameters)) *v1beta12.AddressParameters {
	o := &v1beta12.AddressParameters{
		Address:      &addressIP,
...
func addOutputFields(n *compute.Address) {
	n.Status = v1beta12.StatusReserving
...
func observation(m ...func(*v1beta12.AddressObservation)) *v1beta12.AddressObservation {
	o := &v1beta12.AddressObservation{
		Status:            v1beta12.StatusReserving,
...
func TestGenerateAddress(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"PartialFilled": {
			args: args{
				name: name,
				in: *params(func(p *v1beta12.AddressParameters) {
					p.AddressType = nil
				}),
			},
...
func TestGenerateAddressObservation(t *testing.T) {
	cases := map[string]struct {
		in  compute.Address
		out v1beta12.AddressObservation
	}{
		"AllFilled": {
		...
		"PartialFilled": {
			...
			out: *observation(func(o *v1beta12.AddressObservation) {
				o.CreationTimestamp = ""
			}),
		},
	}
...
func TestLateInitializeSpec(t *testing.T) {
	type args struct {
		spec *v1beta12.AddressParameters
		in   compute.Address
	}
	cases := map[string]struct {
		args args
		want *v1beta12.AddressParameters
	}{
		"AllFilledNoDiff": {
			args: args{
				spec: params(),
		...
		"PartialFilled": {
			args: args{
				spec: params(func(p *v1beta12.AddressParameters) {
					p.AddressType = nil
				}),
				in: *address(),
			},
			want: params(func(p *v1beta12.AddressParameters) {
