...
func SetupContainerRegistry(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha12.ContainerRegistryGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1alpha12.ContainerRegistryGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha12.ContainerRegistry{}).
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha12.ContainerRegistry)
	if !ok {
...
func (e *external) getBucket(cr *v1alpha12.ContainerRegistry) (*storage.Bucket, error) {
	bucketName := ""
	if cr.Spec.ForProvider.Location != "" {
