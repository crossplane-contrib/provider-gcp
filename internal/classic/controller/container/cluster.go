...
import (
	...
	v1beta22 "github.com/crossplane/provider-gcp/apis/classic/container/v1beta2"

	gcp "github.com/crossplane/provider-gcp/internal/classic/clients"
	gke "github.com/crossplane/provider-gcp/internal/classic/clients/cluster"
...
func SetupCluster(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1beta22.ClusterGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1beta22.ClusterGroupVersionKind),
...
func (e *clusterExternal) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) { // nolint:gocyclo
	...
	case v1beta22.ClusterStateRunning, v1beta22.ClusterStateReconciling:
		cr.Status.SetConditions(xpv1.Available())
	case v1beta22.ClusterStateProvisioning:
		cr.Status.SetConditions(xpv1.Creating())
	case v1beta22.ClusterStateUnspecified, v1beta22.ClusterStateDegraded, v1beta22.ClusterStateError:
...
func (e *clusterExternal) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	if cr.Status.AtProvider.Status == v1beta22.ClusterStateProvisioning {
...
func (e *clusterExternal) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	...
	if cr.Status.AtProvider.Status == v1beta22.ClusterStateReconciling || cr.Status.AtProvider.Status == v1beta22.ClusterStateProvisioning {
...
func (e *clusterExternal) Delete(ctx context.Context, mg resource.Managed) error {
	...
	if cr.Status.AtProvider.Status == v1beta22.ClusterStateStopping {
		return nil
	}
