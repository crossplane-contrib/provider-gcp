...
func SetupCloudMemorystoreInstance(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1beta12.CloudMemorystoreInstanceGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1beta12.CloudMemorystoreInstanceGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1beta12.CloudMemorystoreInstance{}).
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) { // nolint:gocyclo
	cr, ok := mg.(*v1beta12.CloudMemorystoreInstance)
	if !ok {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	i, ok := mg.(*v1beta12.CloudMemorystoreInstance)
	if !ok {
