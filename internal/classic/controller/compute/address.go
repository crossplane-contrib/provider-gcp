...
func SetupAddress(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1beta12.AddressGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1beta12.AddressGroupVersionKind),
