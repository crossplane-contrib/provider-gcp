...
func SetupCryptoKeyPolicy(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha12.CryptoKeyPolicyGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1alpha12.CryptoKeyPolicyGroupVersionKind),
...
func (e *cryptoKeyPolicyExternal) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha12.CryptoKeyPolicy)
	if !ok {
