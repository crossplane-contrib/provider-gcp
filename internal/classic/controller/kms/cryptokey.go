...
import (
	...
	"github.com/crossplane/provider-gcp/internal/classic/clients/cryptokey"
...
func SetupCryptoKey(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha12.CryptoKeyGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1alpha12.CryptoKeyGroupVersionKind),
...
func cryptoKeyRRN(cr *v1alpha12.CryptoKey) string {
