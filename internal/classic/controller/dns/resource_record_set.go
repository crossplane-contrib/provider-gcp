...
import (
	...
	v1alpha12 "github.com/crossplane/provider-gcp/apis/classic/dns/v1alpha1"
...
func SetupResourceRecordSet(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha12.ResourceRecordSetGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1alpha12.ResourceRecordSetGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha12.ResourceRecordSet{}).
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha12.ResourceRecordSet)
	if !ok {
