...
import (
	...
	"github.com/crossplane/provider-gcp/internal/classic/clients/serviceaccountpolicy"
...
type sapValueModifier func(ring *v1alpha12.ServiceAccountPolicy)

func sapWithName(s string) sapValueModifier {
	return func(i *v1alpha12.ServiceAccountPolicy) { i.Name = s }
}

func sapWithExternalNameAnnotation(externalName string) sapValueModifier {
	return func(i *v1alpha12.ServiceAccountPolicy) {
...
func sapWithCondition(condition xpv1.Condition) sapValueModifier {
	return func(i *v1alpha12.ServiceAccountPolicy) { i.SetConditions(condition) }
}

func sapWithBinding(binding *v1alpha12.Binding) sapValueModifier {
	return func(i *v1alpha12.ServiceAccountPolicy) {
...
func ServiceAccountPolicy(im ...sapValueModifier) *v1alpha12.ServiceAccountPolicy {
	sap := &v1alpha12.ServiceAccountPolicy{
		ObjectMeta: metav1.ObjectMeta{
			Name:       sapMetadataName,
			Finalizers: []string{},
		},
		Spec: v1alpha12.ServiceAccountPolicySpec{
			ForProvider: v1alpha12.ServiceAccountPolicyParameters{
				ServiceAccountReferer: v1alpha12.ServiceAccountReferer{
					ServiceAccount: &testServiceAccountRRN,
				},
				Policy: v1alpha12.Policy{
					Bindings: []*v1alpha12.Binding{
						{
		...
		"UpdateSucceeded": {
			...
			args: args{
				...
				mg: ServiceAccountPolicy(
					...
					sapWithExternalNameAnnotation(sapMetadataName),
					sapWithCondition(xpv1.Available()),
					sapWithBinding(&v1alpha12.Binding{
						Members: []string{"another-member"},
						Role:    "another-role",
					})),
			},
