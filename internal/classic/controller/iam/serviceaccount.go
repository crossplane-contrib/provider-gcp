...
import (
	...
	"github.com/crossplane/provider-gcp/internal/classic/clients/serviceaccount"
...
func SetupServiceAccount(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha12.ServiceAccountGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1alpha12.ServiceAccountGroupVersionKind),
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha12.ServiceAccount)
	if !ok {
...
func isUpToDate(in *v1alpha12.ServiceAccountParameters, observed *iamv1.ServiceAccount) bool {
...
func populateCRFromProvider(cr *v1alpha12.ServiceAccount, fromProvider *iamv1.ServiceAccount) {
...
func populateProviderFromCR(forProvider *iamv1.ServiceAccount, cr *v1alpha12.ServiceAccount) {
...
func (rrn RelativeResourceNamer) ResourceName(sa *v1alpha12.ServiceAccount) string {
