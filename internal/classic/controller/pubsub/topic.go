...
import (
	...
	"github.com/crossplane/provider-gcp/internal/classic/clients/topic"
...
func SetupTopic(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha12.TopicGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1alpha12.TopicGroupVersionKind),
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	return managed.ExternalObservation{
		...
		ConnectionDetails: managed.ConnectionDetails{
			v1alpha12.ConnectionSecretKeyTopic:       []byte(meta.GetExternalName(cr)),
			v1alpha12.ConnectionSecretKeyProjectName: []byte(e.projectID),
		},
	}, nil
}
