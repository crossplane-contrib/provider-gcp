...
func SetupBucketPolicyMember(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha12.BucketPolicyMemberGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1alpha12.BucketPolicyMemberGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha12.BucketPolicyMember{}).
...
func (e *bucketPolicyMemberExternal) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha12.BucketPolicyMember)
	if !ok {
