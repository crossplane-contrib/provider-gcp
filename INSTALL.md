# Building and Installing the Crossplane GCP Stack

`stack-gcp` is composed of a golang project and can be built directly with standard `golang` tools. We currently support two different platforms for building:
