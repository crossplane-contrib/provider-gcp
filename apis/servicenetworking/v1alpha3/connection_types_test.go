...
func TestGlobalAddressNameReferencerForConnection_AssignInvalidType_ReturnsErr(t *testing.T) {
...
func TestGlobalAddressNameReferencerForConnection_AssignValidType_ReturnsExpected(t *testing.T) {
	...
	if diff := cmp.Diff(res.Spec.ReservedPeeringRanges, []string{"mockValue"}); diff != "" {
