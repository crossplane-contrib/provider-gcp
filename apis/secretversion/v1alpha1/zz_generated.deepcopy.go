...
func (in *KubeSecretRef) DeepCopyInto(out *KubeSecretRef) {
	*out = *in
	if in.Key != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeSecretRef.
func (in *KubeSecretRef) DeepCopy() *KubeSecretRef {
	if in == nil {
		return nil
	}
	out := new(KubeSecretRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecretVersionParameters) DeepCopyInto(out *SecretVersionParameters) {
	*out = *in
	...
	if in.KubeSecretRef != nil {
		in, out := &in.KubeSecretRef, &out.KubeSecretRef
		*out = new(KubeSecretRef)
		(*in).DeepCopyInto(*out)
	}
}
