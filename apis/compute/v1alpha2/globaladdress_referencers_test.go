...
const (
	mockGlobalAddressName = "mockGlobalAddressName"
)

func TestGlobalAddressNameReferencerGetStatus(t *testing.T) {
	...
	for name, tc := range map[string]struct {
		...
		t.Run(name, func(t *testing.T) {
			r := GlobalAddressNameReferencer{LocalObjectReference: corev1.LocalObjectReference{Name: mockName}}
...
func TestGlobalAddressNameReferencerBuild(t *testing.T) {
	type input struct {
		readerFn func(ctx context.Context, key client.ObjectKey, obj runtime.Object) error
	}
	type expected struct {
