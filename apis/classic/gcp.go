...
// Package classic contains classic Kubernetes APIs for GCP cloud provider.
package classic

import (
	"k8s.io/apimachinery/pkg/runtime"

	cachev1beta1 "github.com/crossplane/provider-gcp/apis/classic/cache/v1beta1"
	computev1alpha1 "github.com/crossplane/provider-gcp/apis/classic/compute/v1alpha1"
	computev1beta1 "github.com/crossplane/provider-gcp/apis/classic/compute/v1beta1"
	containerv1beta1 "github.com/crossplane/provider-gcp/apis/classic/container/v1beta1"
	containerv1beta2 "github.com/crossplane/provider-gcp/apis/classic/container/v1beta2"
	databasev1beta1 "github.com/crossplane/provider-gcp/apis/classic/database/v1beta1"
	dnsv1alpha1 "github.com/crossplane/provider-gcp/apis/classic/dns/v1alpha1"
	iam "github.com/crossplane/provider-gcp/apis/classic/iam/v1alpha1"
	kms "github.com/crossplane/provider-gcp/apis/classic/kms/v1alpha1"
	pubsub "github.com/crossplane/provider-gcp/apis/classic/pubsub/v1alpha1"
	registry "github.com/crossplane/provider-gcp/apis/classic/registry/v1alpha1"
