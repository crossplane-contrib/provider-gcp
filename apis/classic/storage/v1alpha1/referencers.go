...
import (
	...
	"github.com/crossplane/provider-gcp/apis/classic/iam/v1alpha1"
	"github.com/crossplane/provider-gcp/apis/classic/storage/v1alpha3"
...
func (in *BucketPolicy) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i := range in.Spec.ForProvider.Policy.Bindings {
		mrsp, err := r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
			...
			Extract:       v1alpha1.ServiceAccountMemberName(),
		})
		if err != nil {
