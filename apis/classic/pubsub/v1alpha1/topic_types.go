...
type TopicParameters struct {
	...
	// +optional
	// +immutable
	// +crossplane:generate:reference:type=github.com/crossplane/provider-gcp/apis/classic/kms/v1alpha1.CryptoKey
	// +crossplane:generate:reference:extractor=github.com/crossplane/provider-gcp/apis/classic/kms/v1alpha1.CryptoKeyRRN()
