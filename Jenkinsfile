pipeline {
    ...
    environment {
        ...
        CODECOV_TOKEN = credentials('codecov-stack-gcp')
    }
            ...
            steps {
                script {
                    if (env.CHANGE_ID != null) {
                        def json = sh (script: "curl -s https://api.github.com/repos/crossplane/stack-gcp/pulls/${env.CHANGE_ID}", returnStdout: true).trim()
